...
| [MidJourney](plugins/MIDJOURNEY.md) | midjourney-api.com REST plus Ace Data Cloud MCP | Provisions separate text-to-image Imagine Templates, polls each transport through its reviewed task operation, and imports every final image; other advertised MCP tools remain outside the execution allowlist | Separate midjourney-api.com and Ace Data Cloud service credentials |
