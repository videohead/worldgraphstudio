	...
	public static function enqueue( string $hook_suffix ): void {
		...
		wp_localize_script( 'worldgraph-asset-generator', 'worldgraphAssetGenerator', [
			...
			'i18n'           => [
				...
				'currentRunSource'  => __( 'This run (not saved)', 'worldgraph' ),
				'initialValueSource' => __( 'Initial value', 'worldgraph' ),
				'inheritedValueSource' => __( 'Inherited value', 'worldgraph' ),
				'templateLayerLabel' => __( 'Template defaults', 'worldgraph' ),
				'projectProfileLayerLabel' => __( 'Project media profile', 'worldgraph' ),
				'projectLayerLabel' => __( 'Project defaults', 'worldgraph' ),
				'itemLayerLabel'    => __( 'Item defaults', 'worldgraph' ),
				'savedDefaultsLayerLabel' => __( 'Saved defaults', 'worldgraph' ),
				'defaultLayerStatusHeading' => __( 'Default layer status', 'worldgraph' ),
				'defaultStatusCurrent' => __( 'Current', 'worldgraph' ),
				'defaultStatusInherited' => __( 'Inherited; no saved override', 'worldgraph' ),
				'defaultStatusRevalidated' => __( 'Revalidated after Template changes', 'worldgraph' ),
				'defaultStatusIncompatible' => __( 'Not used; incompatible with the current Template controls', 'worldgraph' ),
				'defaultStatusInvalidEntry' => __( 'Not used; saved row is invalid', 'worldgraph' ),
				'defaultStatusInvalidDocument' => __( 'Not used; saved defaults repository is invalid', 'worldgraph' ),
				'defaultStatusUnknown' => __( 'Needs review', 'worldgraph' ),
				'defaultWarningInvalidDocument' => __( 'A saved defaults repository is invalid and is not being used. Reset the affected layer before saving new defaults.', 'worldgraph' ),
				'defaultWarningInvalidEntry' => __( 'A saved defaults row is invalid and is not being used. Reset the affected layer.', 'worldgraph' ),
				'defaultWarningIncompatible' => __( 'Saved values are incompatible with the current Template controls and are not being used. Reset the affected layer.', 'worldgraph' ),
				'defaultWarningRevalidated' => __( 'Saved values were revalidated after the Template controls changed. Review them before generating.', 'worldgraph' ),
				'defaultWarningUnknown' => __( 'Saved generation defaults need review.', 'worldgraph' ),
				...
				'saveTemplateDefaults' => __( 'Save current values as Template defaults', 'worldgraph' ),
				...
				'resetTemplateDefaults' => __( 'Reset Template defaults', 'worldgraph' ),
				...
				'confirmResetTemplateDefaults' => __( 'Reset these Template defaults? Every Project and item using this Template will inherit its built-in values.', 'worldgraph' ),
				'confirmResetProjectDefaults' => __( 'Reset these Project defaults and inherit from the Template and Project media profile?', 'worldgraph' ),
				'confirmResetItemDefaults' => __( 'Reset these item defaults and inherit from the Project?', 'worldgraph' ),
				'templateDefaultsHelp' => __( 'Template defaults affect every use of this Template across all Projects and items.', 'worldgraph' ),
