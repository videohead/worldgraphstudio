	...
	public static function render(): void {
		...
		<div class="wrap">
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<p class="description">Direct connectors for services such as Sora, Runway, Veo, Kling, Seedance, Firefly, and Amazon video endpoints require additional API discovery and provider-specific implementation. MidJourney is configured separately from World Graph Studio &gt; Connections because its delivered REST and MCP transports use two independent service credentials.</p>
