...
The WordPress run-control delivery does not move Asset generation to `Partial`:
there is still no usable authenticated headless creator transport or UI, and
