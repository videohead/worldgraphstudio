...
| Story Graph workspace | Public Story collection/detail routes browse published content, but deliberately provide no draft, create, edit, or administrative UI | Missing | Add a permission-aware creator contract and browse/edit workflows; the anonymous `wp/v2` projection must not be treated as workspace authorization |
